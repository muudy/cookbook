...
public class VideoActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private int text = 0;
    final String mainPath = android.os.Environment.getExternalStorageDirectory() + File.separator + "EAT" + File.separator + "Video" + File.separator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (!mStartedFlg) {
                    ...
                    try {
                        ...
                        //通过时间得到文件名称
                        filename = CameraUtil.createFileName(".MP4");
                        videoFile = new File(mainPath, filename);
        ...
        mBTnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e(TAG,"video_path:"+videoFile.getAbsolutePath());
                Toast.makeText(VideoActivity.this,"保存成功！",Toast.LENGTH_SHORT).show();
